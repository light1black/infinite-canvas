export default {
    ...
    settingsPanels: {
        ...
        video: { title: "视频设置", quality: "清晰度", size: "尺寸", seconds: "秒数", resolution: "分辨率", ratio: "比例", duration: "时长", smart: "智能", output: "输出", generateAudio: "生成声音", watermark: "添加水印", adaptive: "自适应", count: "生成数量", videos: "{{count}} 个视频", sizes: { landscape: "横屏", portrait: "竖屏", square: "方形", widescreen: "宽屏", tall: "长图", auto: "自动" }, ratios: { landscape: "横屏", portrait: "竖屏", square: "方形", standardLandscape: "标准横屏", standardPortrait: "标准竖屏", cinematic: "宽银幕", adaptive: "自适应" } },
        audio: { title: "音频设置", voice: "声音", format: "格式", speed: "语速", instructions: "声音指令", instructionsPlaceholder: "例如：自然、温暖、适合旁白。", count: "生成数量", audios: "{{count}} 个音频" },
        text: { title: "文本设置", reasoning: "推理强度", count: "生成数量", results: "{{count}} 个结果" },
    ...
    imageWorkbench: {
        ...
        busy: "生图工作台已有任务正在运行",
        generated: "图片已生成",
        simulatedGenerated: "已生成模拟预览，未调用真实图片服务",
        simulatedPreview: "模拟预览",
        simulatedReason: "未配置本地 Agent 的 OPENAI_COMPATIBLE_IMAGE_API_KEY",
    ...
    canvas: {
        ...
        sidePanel: {
            canvas: "画布", assets: "资产", prompts: "提示词库", resize: "调整左侧面板宽度", elements: "画布元素", select: "选择", searchNodes: "搜索节点", focusNode: "定位到节点", preview: "放大预览", noNodes: "画布暂无节点", loadMoreNodes: "再加载 {{count}} 项", clearAll: "取消全选", selected: "已选 {{count}}", exporting: "正在导出选中元素…", exportName: "画布元素-{{count}}个", exported: "已导出 {{count}} 个元素", exportFailed: "导出失败，请重试",
