export default {
    ...
    settingsPanels: {
        ...
        audio: { title: "Audio settings", voice: "Voice", format: "Format", speed: "Speed", instructions: "Voice instructions", instructionsPlaceholder: "For example: natural, warm, and suitable for narration.", count: "Generation count", audios: "{{count}} audio results" },
        text: { title: "Text settings", reasoning: "Reasoning effort", count: "Generation count", results: "{{count}} results" },
    ...
    imageWorkbench: {
        ...
        simulatedGenerated: "A simulated preview was created without calling the real image service",
        simulatedPreview: "Simulated preview",
        simulatedReason: "OPENAI_COMPATIBLE_IMAGE_API_KEY is not configured for the local Agent",
    ...
    canvas: {
        ...
        sidePanel: {
            canvas: "Canvas", assets: "Assets", prompts: "Prompt Library", resize: "Resize left panel", elements: "Canvas elements", select: "Select", searchNodes: "Search nodes", focusNode: "Focus node", preview: "Large preview", noNodes: "No nodes on this canvas", loadMoreNodes: "Load {{count}} more", clearAll: "Clear all", selected: "{{count}} selected", exporting: "Exporting selected elements…", exportName: "canvas-elements-{{count}}", exported: "Exported {{count}} elements", exportFailed: "Export failed. Try again.",
